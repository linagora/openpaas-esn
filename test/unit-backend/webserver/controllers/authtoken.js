...
describe('The authtoken controller', function() {
  ...
  it('getUser should return HTTP 400 if token is not defined in request', function(done) {
  ...
  it('getUser should return HTTP 500 if auth.getToken sends back error', function(done) {
  ...
  it('getUser should return HTTP 400 if auth.getToken does not send back token', function(done) {
  ...
  it('getUser should return HTTP 404 if auth.getToken does not send back user in token', function(done) {
  ...
  it('getUser should return HTTP 500 if user module does sends back error', function(done) {
  ...
  it('getUser should return HTTP 404 if user module does not sends back user', function(done) {
  ...
  it('getUser should return HTTP 200 if user module sends back user', function(done) {
