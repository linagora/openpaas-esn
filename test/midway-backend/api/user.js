...
describe('User API', function() {
  ...
  describe('POST /api/user/configuration', function() {
    it('should return 401 if user is not authenticated', function(done) {
      this.helpers.api.requireLogin(webserver.application, 'post', '/api/user/configuration', done);
    });

    it('should return 400 if body is not an array', function(done) {
      const self = this;

      self.helpers.api.loginAsUser(webserver.application, self.models1.users[1].emails[0], 'secret', function(err, loggedInAsUser) {
        expect(err).to.not.exist;

        const req = loggedInAsUser(request(webserver.application).post('/api/user/configuration'));

        req.send({});
        req.expect(400).end(self.helpers.callbacks.noErrorAnd(function(res) {
    ...
    it('should return 400 if one of modules is undefined', function(done) {
      const self = this;
    ...
    it('should return 400 if module.keys if not an array', function(done) {
      const self = this;
    ...
    it('should return 400 if user have not permission to read one of configurations', function(done) {
      const self = this;
    ...
    it('should send back 200 on success', function(done) {
      const self = this;
      ...
      self.helpers.api.loginAsUser(webserver.application, self.models1.users[1].emails[0], 'secret', function(err, loggedInAsUser) {
        ...
        req.send(data);
        req.expect(200).end(self.helpers.callbacks.noErrorAnd(function(res) {
  ...
  describe('PUT /api/user/configuration', function() {
    it('should return 401 if user is not authenticated', function(done) {
      this.helpers.api.requireLogin(webserver.application, 'put', '/api/user/configuration', done);
    });
    ...
    it('should return 400 if body is not an array', function(done) {
      ...
      self.helpers.api.loginAsUser(webserver.application, self.models1.users[1].emails[0], 'secret', function(err, loggedInAsUser) {
        ...
        const req = loggedInAsUser(request(webserver.application).put('/api/user/configuration'));
    ...
    it('should return 400 if module.configurations is not array', function(done) {
      const self = this;
    ...
    it('should return 400 if one config in module.configurations is undefined', function(done) {
      const self = this;
    ...
    it('should return 400 if user have not permission to update one of configurations', function(done) {
      const self = this;
    ...
    it('should send back 204 on success', function(done) {
      ...
      self.helpers.api.loginAsUser(webserver.application, self.models1.users[1].emails[0], 'secret', function(err, loggedInAsUser) {
        ...
        req.send(data);
        req.expect(204).end(self.helpers.callbacks.noErrorAnd(function(res) {
          expect(res.body).to.not.exists;
          done();
        }));
      });
