...
describe('The redis pubsub module', function() {
  ...
  beforeEach(function() {
    this.localpubsub = this.helpers.requireBackend('core').pubsub.local.topic('redis:configurationAvailable');
    this.pubsub1 = this.helpers.requireBackend('core/pubsub/global').topic('testTopic');
    this.pubsub2 = this.helpers.requireBackend('core/pubsub/global').topic('testTopic');
