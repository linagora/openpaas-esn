...
module.exports = function(config) {
  ...
  config.set({
    ...
    files: [
      ...
      'frontend/components/angular-material/modules/js/showHide/showHide.min.css',
      ...
      'frontend/components/angular-material/modules/js/fabActions/fabActions.min.css',
      'frontend/components/angular-material/modules/js/fabSpeedDial/fabSpeedDial.min.css',
      'frontend/components/angular-material/modules/js/fabTrigger/fabTrigger.min.css',
