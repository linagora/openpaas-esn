...
describe('The esnCollaborationInvitationDeclineButton directive', function() {
  ...
  beforeEach(angular.mock.inject(function($rootScope, $compile, esnCollaborationClientService, esnUserNotificationService, esnCollaborationMembershipInvitationNotificationDirective) {
    ...
    this.html = '<esn-collaboration-membership-invitation-notification notification="notification"><esn-collaboration-invitation-decline-button/></esn-collaboration-membership-invitation-notification>';
  }));
