(function(angular) {
  ...
  function ESNCommunityMembersTabsController($rootScope, communityAPI, communityService, session, esnCollaborationClientService, ESN_COLLABORATION_MEMBER_EVENTS) {
    var self = this;
    var calling = false;
