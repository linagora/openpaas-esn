...
exports = module.exports = function(application) {
  ...
  application.post('/api/messages', authorize.requiresAPILogin, messageMiddleware.canReplyTo, asMiddleware.filterWritableTargets, requestMW.assertRequestElementArrayAndNotEmpty('message_targets'), messages.createOrReplyToMessage);
