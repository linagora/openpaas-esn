...
exports = module.exports = function(application) {
  ...
  application.put('/api/communities/:id/membership/:user_id', authorize.requiresAPILogin, communities.load, communityMiddleware.checkUserIdParameterIsCurrentUser, communities.addMembershipRequest);
