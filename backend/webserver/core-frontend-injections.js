...
const injections = [
  ...
  {angular: 'esn.community', files: [
    ...
    'community/pending-invitation/community-pending-invitation-list.directive.js',
    'community/pending-invitation/community-pending-invitation-display.directive.js',
