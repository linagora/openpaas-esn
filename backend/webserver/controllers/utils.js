...
function sanitizeUser(u) {
  ...
  ['_id', 'firstname', 'lastname', 'preferredEmail', 'emails', 'domains', 'avatars', 'accounts', 'job_title',
    'service', 'building_location', 'office_location', 'main_phone', 'features'].forEach(function(key) {
    if (user[key]) {
