...
addDebianRepositories() {
    ...
    addDebianRepository openpaas "deb https://packages.linagora.com/deb/openpaas/v1.4 ${DEBIAN_RELEASE} main"
...
addRedhatRepositories() {
    ...
    addRedhatRepository openpaas 'https://packages.linagora.com/rpm/v1.4/7/'
}
