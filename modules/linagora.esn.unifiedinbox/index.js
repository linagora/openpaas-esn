...
var unifiedInboxModule = new AwesomeModule('linagora.esn.unifiedinbox', {
  ...
  states: {
    ...
    deploy: function(dependencies, callback) {
      ...
      webserverWrapper.injectAngularModules('unifiedinbox', ['app.js', 'constants.js', 'controllers.js', 'directives.js', 'services.js', 'jmap-wrapper.js'], 'linagora.esn.unifiedinbox', ['esn']);
