...
angular.module('esn.appstore')
  ...
  .directive('applicationMenuAppstore', function(applicationMenuTemplateBuilder) {
    return {
      retrict: 'E',
      replace: true,
      template: applicationMenuTemplateBuilder('/#/controlcenter/appstore', 'appstore', 'Modules', 'core.features.application-menu:appstore', false)
    };
  })
  .directive('controlcenterMenuAppstore', function(controlCenterMenuTemplateBuilder) {
    return {
      retrict: 'E',
      template: controlCenterMenuTemplateBuilder('controlcenter.appstore', 'mdi-package-variant', 'Modules', 'core.features.control-center:appstore')
    };
  })
