...
describe('The calUIAuthorizationService service', function() {
  var calUIAuthorizationService, calEventUtils, event, CAL_DEFAULT_CALENDAR_ID;
  ...
  beforeEach(function() {
    ...
    angular.mock.inject(function(_calUIAuthorizationService_, _calEventUtils_, _CAL_DEFAULT_CALENDAR_ID_) {
