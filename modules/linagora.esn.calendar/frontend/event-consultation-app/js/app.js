...
angular.module('esn.calendar.event-consultation', ['uuid4', 'AngularJstz', 'esn.core', 'esn.lodash-wrapper', 'esn.calendar', 'esn.header', 'esn.ical', 'esn.fcmoment', 'esn.application-menu', 'op.dynamicDirective', 'mgcrea.ngStrap.popover'])
