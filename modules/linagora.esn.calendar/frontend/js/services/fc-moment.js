(function() {
   ...
   */
  angular.module('esn.fcmoment', ['angularMoment'])
         .factory('fcMoment', fcMoment);
  ...
  function fcMoment($window, ICAL, moment) {
    function _fcMoment(time) {
    ...
    angular.extend(_fcMoment, moment);
