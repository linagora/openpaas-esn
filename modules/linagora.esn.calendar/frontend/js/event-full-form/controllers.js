...
angular.module('esn.calendar')
  ...
  .controller('eventFullFormController', function($rootScope, $scope, $alert, calendarUtils, calendarService, calendarEventEmitter, eventService, gracePeriodService, moment, session, notificationFactory, ICAL_PROPERTIES, EVENT_FORM, EVENT_MODIFY_COMPARE_KEYS) {
