...
## GET /api/communities/{community_id}/membership
...
**Request:**
    ...
    GET /api/communities/538e3bd6654d7c3307f990fa/membership
    Accept: application/json
    Host: localhost:8080
...
## GET /api/communities/{community_id}/invitablepeople
...
**Request:**
    ...
    GET /api/communities/987654321/invitablepeople
    Accept: application/json
    Host: localhost:8080
